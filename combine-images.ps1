docker manifest rm minnyres/amule-dlp:latest
docker manifest rm minnyres/amule-dlp:official-2.3.3
...
docker manifest create minnyres/amule-dlp:latest minnyres/amule-dlp:dlp-arm64-v8 minnyres/amule-dlp:dlp-s390x   minnyres/amule-dlp:dlp-arm-v6  minnyres/amule-dlp:dlp-arm-v7  minnyres/amule-dlp:dlp-amd64  minnyres/amule-dlp:dlp-ppc64le minnyres/amule-dlp:dlp-riscv64 minnyres/amule-dlp:dlp-loong64 minnyres/amule-dlp:dlp-mips64le --amend
